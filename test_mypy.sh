...
yes | scp -i root_key ./mypy_test_cache.zip root@$serverIp:~/cache/binux---pyspider-Pair1-before.zip
yes | scp -i root_key ./mypy_test_report.txt root@$serverIp:~/report/binux---pyspider-Pair1-before.txt
